    ...
    <section className='flex flex-col h-[70vh]'>
      <section className='flex gap-8 max-md:flex-col'>
          ...
          >
            ...
            className={
              cn(
                  ...
                  'opacit-100':'opacity-0',callStatus===CallStatus.CONNECTING  && 'opacity-100 animate-pulse'
                )
            }>
              <Image
        ...
        <div className='user-section'>
            ...
            <button className={cn('rounded-lg py-2 cursor-pointer transition-colors w-full',
